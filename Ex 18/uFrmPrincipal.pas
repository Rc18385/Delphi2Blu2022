...
{18. Faça um algoritmo que receba a idade de 75 (pode usar 5 para testar)
...
begin
  ...
  begin
    ...
    if (xIdade >= 18) then
    TeditResposta.Text:= ('Olá '+(xNome)+' você é maior de idade')
    else
    if (xIdade <= 17) then
    TeditResposta.Text:= ('Olá '+(xNome)+' você é menor de idade');
  end;
