...
begin
  ...
  begin
    xProduto    := (inputbox('Informe','Escreva qual é o produto',''));
    xPrecoCusto := StrToFloat(inputbox('Informe','Informe o preço de custo do ' +
                                      'produto',''));
    xPrecoVenda := StrToFloat(inputbox('Informe','Informe o preço de venda do ' +
                                      'produto',''));

    if (xPrecoVenda > xPrecoCusto) then
      mmResultado.Lines.Add(('O produto gerou lucro') + #13#10)
    else if (xPrecoVenda = xPrecoCusto) then
      mmResultado.Lines.Add(('O produto não gerou lucro') + #13#10)
    else if (xPrecoVenda < xPrecoCusto) then
      mmResultado.Lines.Add(('O produto gerou prejuízo') + #13#10);
  ...
  mmResultado.Lines.Add('O produto tem o seguinte preço de custo R$ ' +
                        FloatToStr(xPrecoCusto) + ' e o seguinte preço de venda R$ ' +
                        FloatToStr(xPrecoVenda)+ #13#10);
  mmResultado.Lines.Add('O produto teve um total de ' +
                        FloatToStr(xQuantProd) + ' vendas.' + #13#10);
  mmResultado.Lines.Add('O preço médio de venda do produto é de R$ ' +
                      FloatToStr(xMediaVenda) + #13#10);
  mmResultado.Lines.Add('O preço médio de custo do produto é de R$ ' +
