...
begin
  ...
  mmResultado.Lines.Add('O número de carros com ano inferior a 2000 é de ' +
                        IntToStr(xContadorMenor));
  mmResultado.Lines.Add('O número de carros com ano superior a 2000 é de ' +
                        IntToStr(xContadorMaior));
  xSomaContadores := (xContadorMenor + xContadorMaior);
  mmResultado.Lines.Add('O número de carros total é de ' + IntToStr(xSomaContadores));
